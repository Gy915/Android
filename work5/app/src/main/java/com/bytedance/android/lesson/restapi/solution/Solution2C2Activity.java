...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    public List<Call>mPostVideoResponse= new ArrayList<>();;
    @Override
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> postVideoResponseCall =iMiniDouyinService.createVideo("1120170736","Gy",cover_image,video);
    ...
    public void fetchFeed(View view) {
        ...
        Retrofit retrofit= RetrofitManager.get("http://test.androidcamp.bytedance.com/mini_douyin/");
        IMiniDouyinService iMiniDouyinService=retrofit.create(IMiniDouyinService.class);
        Call<FeedResponse> listCall=iMiniDouyinService.fetchFeed();
        listCall.enqueue(new Callback<FeedResponse>(){
